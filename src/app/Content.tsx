  ...
  const systemOptions = [
    {
      name: "Friendly",
      prompt:
        "You're a friendly assistant. Check previous messages for answers before answering any questions. If you don't know the answer state that you do not know it",
    },
    {
      name: "Grumpy",
      prompt:
    ...
    },
    {
      name: "Pirate",
      prompt:
        "You're a nice assistant that talks like a pirate. Check previous messages for answers before answering any questions. If you don't know the answer state that you do not know it",
    },
  ];
